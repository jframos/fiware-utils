...
if __name__ == '__main__':
     nova_operations = FiwareNovaOperations(
                                                "jfernandez@tcpsi.es",
                                                "FILAB53593",
                                                "00000000000000000000000000004259",
                                                "http://cloud.lab.fi-ware.org:4731/v2.0/",
                                                "Spain")

     #nova_operations.allocate_ip("net8300")
     nova_operations.deallocate_ip("612")